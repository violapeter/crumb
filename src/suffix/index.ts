...
export const suffix = {
  accusative: createSuffixer(
    accusative,
    createGeneralExceptions(ACCUSATIVE_CONJUGATION),
  ),
...
export const grade = {
  comparative: createSuffixer(
    comparative,
    createGeneralExceptions(GRADE_CONJUGATION),
  ),
  superlative: createSuffixer(
    superlative,
    createGeneralExceptions(GRADE_CONJUGATION),
  ),
  excessive: createSuffixer(
    excessive,
    createGeneralExceptions(GRADE_CONJUGATION),
  ),
}
